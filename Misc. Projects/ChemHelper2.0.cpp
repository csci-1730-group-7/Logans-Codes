...
double singleElementMass();
double compoundElementMass();
double singleElementMoles();
double compoundElementMoles();
float averageCalculator();
float quadraticFormula();


const double H=1.0079,He=4.0026,Li=6.941,Be=9.0122,B=10.811,C=12.0107,N=14.0067,O=15.994,F=18.9984;
const double Ne=20.1797,Na=22.9897,Mg=24.305,Al=26.9815,Si=28.0855,P=30.9738,S=32.065,Cl=35.453,K=39.0983,Ar=39.948,Ca=40.078;
const double Sc=44.9559,Ti=47.867,V=50.9415,Cr=51.9961,Mn=54.938,Fe=55.845,Ni=58.6934,Co=58.9332,Cu=63.546,Zn=65.39,Ga=69.723,Ge=72.64,As=74.9216;
const double Se=78.96,Br=79.904,Kr=83.8,Rb=85.4678,Sr=87.62,Y=88.9059,Zr=91.224,Nb=92.9064,Mo=95.94,Tc=98,Ru=101.07,Rh=102.9055,Pd=106.42;
const double Ag=107.8682,Cd=112.411,In=114.818,Sn=118.71,Sb=121.76,I=126.9045,Te=127.6,Xe=131.293,Cs=132.9055,Ba=137.327,La=138.9055,Ce=140.116,Pr=140.9077;
const double Nd=144.24,Pm=145,Sm=150.36,Eu=151.964,Gd=157.25,Tb=158.9253,Dy=162.5,Ho=164.9303,Er=167.259,Tm=168.9342,Yb=173.04,Lu=174.967,Hf=178.49;
const double Ta=180.9479,W=183.84,Re=186.207,Os=190.23,Ir=192.217,Pt=195.078,Au=196.9665,Hg=200.59,Tl=204.3833,Pb=207.2,Bi=208.9804,Po=209,At=210;
const double Rn=222,Fr=223,Ra=226,Ac=227,Pa=231.0359,Th=232.0381,Np=237,U=238.0289,Am=243,Pu=244,Cm=247,Bk=247,Cf=251;
const double Es=252,Fm=257,Md=258,No=259,Lr=266,Rf=267,Db=268,Sg=269,Bh=270,Hs=277,Mt=278,Ds=281,Rg=282,Cn=285,Nh=286,Fl=289,Mc=290,Lv=293,Ts=294,Og=294;
...
char loopContinue;
//switch declarations 
float amountElement;//molar mass single element
string elementChoice;//molar mass single element
string sigCom;//molar mass single element
float massEle[20];//molar mass single element
int c=0, i;//molar mass single element
float sumCom=0;//molar mass single element

cout<<"Which operation shall I perform?\n";
cout<<endl;
do{
cout<<"(Molar Mass [1])(Grams to moles [2])(Calculate average [3])(Quadratic Formula [4])\n";
cin>>resp;
...
cin>>sigCom;
if(sigCom=="e"){singleElementMass();}
else if(sigCom=="c"){compoundElementMass();}
else{cout<<"Tu eres un hijo de puta\n";}
break;

case 2:
cout<<"Find moles of substance\n";
cout<<endl;
cout<<"Element or Compound? (E/C)\n";
cin>>sigCom;
if(sigCom=="e"){singleElementMoles();}
else if(sigCom=="c"){compoundElementMoles();}
else{cout<<"I cannot believe that you are so stupid";}
break;
...
default:
cout<<"I cannot do that operation at this time."<<endl<<"Tu eres un pendejo!\n";
