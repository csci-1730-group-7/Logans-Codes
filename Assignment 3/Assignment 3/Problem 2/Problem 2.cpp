...
public:
	...
	const bool getNegSign() const { return negSign; };*/

	//simple arthimatic functions
	friend Complex operator+(const Complex &numberOne, const Complex &numberTwo);
	friend Complex operator-(const Complex &numberOne, const Complex &numberTwo);
...
Complex operator+ (const Complex &numberOne, const Complex &numberTwo)
{
	Complex q;

	q.a = numberOne.a + numberTwo.a;
	q.b = numberOne.b + numberTwo.b;
...
Complex operator-  (const Complex &numberOne, const Complex &numberTwo)
{
	...
	if (numberOne.b - numberTwo.b > 0) { q.negSign = false; }
